...
class Ui_dial_add_player(object):
    def setupUi(self, dial_add_player):
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 10, 217, 121))
        ...
        self.splitter.setGeometry(QtCore.QRect(40, 170, 150, 23))
        self.splitter.setOrientation(QtCore.Qt.Horizontal)
        self.splitter.setObjectName(_fromUtf8("splitter"))
        self.btnAdd = QtGui.QPushButton(self.splitter)
        self.btnAdd.setObjectName(_fromUtf8("btnAdd"))
        self.btnOK = QtGui.QPushButton(self.splitter)
        self.btnOK.setObjectName(_fromUtf8("btnOK"))
        self.label_status = QtGui.QLabel(dial_add_player)
        self.label_status.setGeometry(QtCore.QRect(20, 140, 201, 21))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, dial_add_player):
        ...
        self.btnAdd.setText(_translate("dial_add_player", "Add", None))
        self.btnOK.setText(_translate("dial_add_player", "Cancel", None))
