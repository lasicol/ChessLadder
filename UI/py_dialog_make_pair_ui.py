...
class Ui_dial_make_pair(object):
    def setupUi(self, dial_make_pair):
        ...
        self.num_round = QtGui.QSpinBox(dial_make_pair)
        self.num_round.setGeometry(QtCore.QRect(170, 40, 42, 22))
        self.num_round.setObjectName(_fromUtf8("num_round"))
